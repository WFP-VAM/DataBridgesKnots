...
setup(
    name='DataBridgesUtils',
    version='1.0.0',
    description='Wrapper for Data Bridges API client',
    long_description=long_description,
    long_description_content_type='text/markdown',
    url='https://github.com/your_org/DataBridgesUtils',
    ...
    install_requires=[
        ...
        'pystata',
        'stata-setup',
        'DataBridgesAPI @ git+ssh://git@github.com:WFP-VAM/DataBridgesAPI.git',
    ],
    extras_require={
        'dev': [
            'black',
    ...
    project_urls={
        'Source': 'https://github.com/your_org/DataBridgesUtils',
    },
)
