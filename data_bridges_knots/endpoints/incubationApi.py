...
class IncubationApi:
    ...
    def get_cari_adm0(self, iso3[Optional]=None, survey_id[Optional]=None, indicator_id[Optional]=None, page[Optional]=1) -> pd.DataFrame:
        """"
        Retrieves a paginated list of Adm0 CARI results based on the specified indicator, administrative code, and survey.

        Args:
            iso3 (str, optional): ISO3 code of the country for which to retrieve Adm0 CARI results. If not provided, retrieves results for all countries.
        ...
        with data_bridges_client.ApiClient(self.configuration) as api_client:
            ...
            adm0code = get_adm0_code(iso3) if iso3 else None
            ...
            try:
                ...
                logger.info(f"The response of IncubationApi->cari_adm0_values_get: {api_response}\n")
    ...
    def get_cari_adm1(self, iso3[Optional]=None, survey_id[Optional]=None, indicator_id[Optional]=None, page[Optional]=1):
        """"
        Retrieves a paginated list of Adm1 CARI results based on the specified indicator, administrative code, and survey.

        Args:
            iso3 (str, optional): ISO3 code of the country for which to retrieve Adm1 CARI results. If not provided, retrieves results for all countries.
        ...
        with data_bridges_client.ApiClient(self.configuration) as api_client:
            ...
            try:
                ...
                logger.info(f"The response of IncubationApi->cari_adm1_values_get: {api_response}\n")
                ...
                logger.error("Exception when calling IncubationApi->cari_adm1_values_get: %s\n" % e)

    def get_cari_data(self, admin_level="admin0", iso3[Optional]=None, survey_id[Optional]=None, indicator_id[Optional]=None, page[Optional]=1):
        """"
        ...
        Args:
            iso3 (str, optional): ISO3 code of the country for which to retrieve CARI results. If not provided, retrieves results for all countries.
        ...
        if admin_level == "admin0" or admin_level == "admin1":
            if admin_level == "admin0":
                return self.get_cari_adm0(iso3=iso3, survey_id=survey_id, indicator_id=indicator_id, page=page)
            elif admin_level == "admin1":
                return self.get_cari_adm1(iso3=iso3, survey_id=survey_id, indicator_id=indicator_id, page=page) 
        else:
